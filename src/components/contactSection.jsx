...
const ContactInfo = () => {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-secondary/50 relative overflow-hidden">
      ...
      <div className="container w-[80vh] mx-auto p-8 md:px-6 border-2 shadow-blue-400 shadow-sm rounded-lg">
        <div className="items-center">
          ...
          >
            <div className="inline-block px-3 py-1 mb-4 text-lg font-medium bg-primary/10 rounded-full text-primary">
              Get in Touch
            </div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">deepak.rajput@dcodepro.com</p>
                </div>
              </div>
